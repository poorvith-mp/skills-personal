...
- [references/what-to-track.md](references/what-to-track.md) — Categories of information to observe and save
- [references/memory-operations.md](references/memory-operations.md) — How to store, organize, update, and recall user knowledge

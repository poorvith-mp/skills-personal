...
## Process
1. Understand the user's knowledge needs and workflow
2. Design the folder/tag structure (PARA method or alternative)
3. Set up capture, organize, and retrieval workflows
4. Recommend tools and integrations
5. Create a maintenance and review system
## Output Format
